...
public class HomeController {
	...
	@RequestMapping(value = "/main/single", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/main/typo", method = RequestMethod.GET)
	public String typo(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	@RequestMapping(value = "/main/sub", method = RequestMethod.GET)
