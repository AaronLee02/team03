...
<div class="welcome">
	 <div class="container">
		 ...
		 <div class="col-md-9 welcome-right">
			 ...
			 <p> 조금씩 마음을 모을수 있도록 선물하기 기능과 크라우드펀딩 기능을 결합한 '모아'를 통해 서로의 소중한 순간을 기억하고 축하하며 부담없는 선물하기 문화를 경험하세요.
</p>
		 </div>
	 </div>
</div>
	 ...
	 <div class="container">
		 ...
		 <div class="feature-grids">
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product.html"><img src="/resources/images/f1.jpg" alt=""/>	
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="/resources/images/f2.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 68000</p>
			 ...
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product.html"><img src="/resources/images/f3.jpg" alt=""/>	
					 <div class="arrival-info">
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="/resources/images/f4.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 12000</p>
						 <span class="pric1"><del>Rs 18000</del></span>
		 ...
		 <div class="feature-grids">
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product.html"><img src="/resources/images/p7.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 12000</p>
						 <span class="pric1"><del>Rs 18000</del></span>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="/resources/images/p11.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 12000</p>
						 <span class="pric1"><del>Rs 18000</del></span>
			 ...
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product.html"><img src="/resources/images/p12.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 12000</p>
						 <span class="pric1"><del>Rs 18000</del></span>
...
<div class="arrivals">
	 <div class="container">	
		 ...
		 <div class="arrival-grids">			 
			 <ul id="flexiselDemo1">
				 <li>
					 <a href="product.html"><img src="/resources/images/a1.jpg" alt=""/>	
					 <div class="arrival-info">
				 ...
				 <li>
					 <a href="product.html"><img src="/resources/images/a2.jpg" alt=""/>
						<div class="arrival-info">
				 ...
				 <li>
					 <a href="product.html"><img src="/resources/images/a3.jpg" alt=""/>	
						<div class="arrival-info">
				 ...
				 <li>
				    <a href="product.html"> <img src="/resources/images/a4.jpg" alt=""/>	
						<div class="arrival-info">
