		 ...
		 <div class="col-md-9 det">
				 <div class="single_left">
					 <div class="flexslider">
							<ul class="slides">
								<li data-thumb="/resources/images/s11.jpeg">
									<img src="/resources/images/s11.jpeg" />
								</li>
								<li data-thumb="/resources/images/s22.jpeg">
									<img src="/resources/images/s22.jpeg" />
								</li>
								<li data-thumb="/resources/images/s33.jpeg">
									<img src="/resources/images/s33.jpeg" />
								</li>
								<li data-thumb="/resources/images/s44.jpeg">
									<img src="/resources/images/s44.jpeg" />
								</li>
							</ul>
						</div>
						FlexSlider
							...
							<table class="table table-bordered">
								...
								<c:forEach items="${list}" var="boardVO">
									...
									<tr>
										<td>${boardVO.bno}</td>
										<td><a
											href='/main/readPage${pageMaker.makeSearch(pageMaker.cri.page) }&bno=${boardVO.bno}'>
			...
			<div class="arrival-grids">
				<ul id="flexiselDemo1">
					<li><a href="product.html"><img
							src="/resources/images/p2.jpg" alt="" />
					...
					<li><a href="product.html"><img
							src="/resources/images/p3.jpg" alt="" />
							<div class="arrival-info">
								<h4>Jewellerys #1</h4>
								<p>Rs 14000</p>
					...
					<li><a href="product.html"><img
							src="/resources/images/p4.jpg" alt="" />
							<div class="arrival-info">
								<h4>Jewellerys #1</h4>
								<p>Rs 4000</p>
					...
					<li><a href="product.html"> <img
							src="/resources/images/p5.jpg" alt="" />
							<div class="arrival-info">
								<h4>Jewellerys #1</h4>
								<p>Rs 18000</p>
			...
			<div class="row row1 scroll-pane">
				...
				<div class="col col-4">
					<label class="checkbox"><input type="checkbox"
						...
						name="checkbox"><i></i>Silver (30)</label> <label class="checkbox"><input
						type="checkbox" name="checkbox"><i></i>Jewellery Sets (30)</label>
					<label class="checkbox"><input type="checkbox"
